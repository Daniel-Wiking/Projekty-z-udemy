...
const changeToLight= document.querySelector('.light');
const changeToDark= document.querySelector('.dark');
...
const checkForm = () => {
   if(nameInput.value !==''&&amountInput.value !==''&&categorySelect !=='none'){
...
indexOfTransaction = moneyArr.indexOf(transactionAmount);
...
changeToLight.addEventListener('click',changeStyleToLight);